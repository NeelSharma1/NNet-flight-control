...
constexpr int r = 20925722;                              // ft
constexpr double g0 = 32.2;                              // ft/s^2
constexpr int R = 1716;                                  // ft * lb / (slug * Rankine)
constexpr double sltemp = 518.67;                        // Rankine
constexpr double slpressure = 2116.22;                   // lb/sqft
constexpr double sldensity = 0.002377;                   // slug/ft^3
constexpr double a1 = -6.5e-3 / 3.2808399 * 1.8;         // Rankine / ft
constexpr double a2 = 3e-3 / 3.2808399 * 1.8;            // Rankine / ft
constexpr double layer1alt = 36089;                      // ft
constexpr double layer2alt = 82349;                      // ft
constexpr double zero = 0;                               //
constexpr double isothermheight = layer2alt - layer1alt; // ft
constexpr double isothermtemp = sltemp + layer1alt * a1; // Rankine
